...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Convolution in Digital Signal Processing';
            ...
            app.Image.Position = [16 141 245 190];
            app.Image.ImageSource = 'Conv2D.gif';
            ...
            app.ReviewTitle.Text = 'Welcome to Convolution in Digital Signal Processing';
