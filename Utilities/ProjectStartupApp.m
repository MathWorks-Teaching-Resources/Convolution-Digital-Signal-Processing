classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Convolution-Digital-Signal-Processing";
        ImagePath {mustBeFile} = fullfile("Images","Conv2D.gif"); 
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.StartUpAppUIFigure.Position = [100 100 276 495];
            ...
            app.WelcomePanel.Position = [-551 98 244 410];
            ...
            app.CoverImage.ImageSource = 'Conv2D.gif';
            ...
            app.FeedBackPanel.Position = [-291 98 236 409];
